...
export default class Validators extends Component{
    ...
    render() {
        ...
        return <div id="validator-list">
            <Helmet>
                <title>Cosmos Validator List on Kratos Explorer | Block-X</title>
            ...
            <p className="lead validator-des-tag">{desc}</p>
            <Row className="validator-list">
                <Col md={12}>
                    <Card body>
                        <Row className="header text-nowrap">
                            <Col className="d-none d-md-block counter" md={1}>&nbsp;</Col>
                            <Col className="moniker row_align_center" md={3} onClick={(e) => this.toggleDir('moniker',e)}>
                              {/*<i className="material-icons">perm_contact_calendar</i> */}
                              <i className="base_icon block_producer size_20_20 mgr_9"></i>
                              <span className="d-inline-block d-md-none d-lg-inline-block">
                                <T>validators.moniker</T>
                               </span> 
                               {renderToggleIcon(this.state.monikerDir)} 
                            </Col>
                            <Col className="voting-power text-left row_align_center" md={3} lg={2} onClick={(e) => this.toggleDir('votingPower',e)}>
                              {/*<i className="material-icons">power</i>*/}
                              <div className="base_icon voting_icon size_20_20 mgr_9"></div>
                              <span className="d-inline-block d-md-none d-lg-inline-block">
                            ...
                            {(this.props.inactive)?<Col className="bond-status d-none d-md-block row_align_center " md={1} onClick={(e) => this.toggleDir('status',e)}>
                              {/*<i className="material-icons">toggle_on</i> */}
                              <div className="row_align_center">
                              <div className="base_icon jail_status_icon size_20_20 mgr_9"></div>
                              <span className="d-md-none d-lg-inline-block">
                                <T>validators.status</T>
                              </span>{renderToggleIcon(this.state.statusDir)}</div></Col>:''}
