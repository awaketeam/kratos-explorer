            ...
            if (self.props.validators.length> 0){
                ...
                self.setState({
                    validators: validators.map((validator, i ) => {
                        return <tr key={i}>
                            <td><Link to={"/validator/"+validator.operator_account}>
                            ...
                            <td className="process_normal"><Progress animated value={validator.uptime}>{validator.uptime?validator.uptime.toFixed(2):0}%</Progress></td>
                        </tr>
                    })
                })
            }
                ...
                return <Card>
                    ...
                    <CardBody>
                        <Table striped className="random-validators">
                            <thead>
                                <tr>
                                    <th className="moniker row_align_center ">
                                    ...
                                    <th className="voting-power">
                                      ...
                                      <div className="row_align_center row_justify_end">
