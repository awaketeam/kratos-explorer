            ...
            if (this.props.statusExist && this.props.status.prevotes){
                return(
                    <Row className="status text-center">
                        <Col lg={3} md={6}>
                            <Card body>
                                <CardTitle className="analytics_info_text"><T>chainStatus.latestHeight</T></CardTitle>
                                <CardText>
                        ...
                        <Col lg={3} md={6}>
                            <Card body>
                                ...
                                <CardTitle className="analytics_info_text"><T>chainStatus.averageBlockTime</T></CardTitle>
                                <CardText>
                        ...
                        <Col lg={3} md={6}>
                            <Card body>
                                <CardTitle className="analytics_info_text"><T>chainStatus.activeValidators</T></CardTitle>
                                <CardText><span className="display-4 value text-primary">{this.state.numValidators}</span><T totalValidators={this.state.totalNumValidators}>chainStatus.outOfValidators2</T></CardText>
                            </Card>
                        </Col>
                        <Col lg={3} md={6}>
                            <Card body>
                                ...
                                <CardTitle className="analytics_info_text"><T>chainStatus.onlineVotingPower</T> ({this.state.votingPowerText})</CardTitle>
                                <CardText>
                                  <span className="display-4 value text-primary">{this.state.votingPower}</span>
                                    <T percent={numbro(this.state.bondedTokens/this.state.totalSupply).format("0.00%")} >chainStatus.fromTotalStakes2</T>
                                  </CardText>
                            </Card>
                        </Col>
                    </Row>
