        ...
        return (
            <div>
                <Navbar color="light" light expand="md" fixed="bottom" id="footer" className="d-none d-md-flex">
                    <span className="text-muted"><a href="https://raw.githubusercontent.com/awaketeam/kratos-explorer/blob/main/LICENSE" target="_blank"><T>navbar.license</T></a> &copy;2019-{moment().format('YYYY')} By Block-X.io </span>
                    <Nav className="ml-auto" navbar>
                        <NavItem>
                            <NavLink href="https://www.github.com/awaketeam/kratos-explorer" target="_blank"><i className="fab fa-github"></i> <T>navbar.forkMe</T></NavLink>
                        </NavItem>
                    </Nav>
                </Navbar>
