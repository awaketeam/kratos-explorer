    ...
    render(){
        if (this.props.loading){
            ...
            if (this.props.blockExist){
                ...
                return <Container id="block">
                    <Helmet>
                        <title>Block {numbro(block.height).format("0,0")} on Kratos Explorer | Block-X</title>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value"><Link to={"/validator/"+((proposer)?proposer.operator_account:'')}>
                                  <Avatar moniker={moniker} profileUrl={profileUrl} address={block.proposerAddress} 
