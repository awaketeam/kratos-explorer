...
export class Ledger {
  ...
  checkLedgerErrors(
    ...
    static createRedelegate(
        ...
        const txMsg = {
            type: 'kuchain/MsgBeginRedelegate',
            value: {
                amount: {
                    amount: uatomAmount.toString(),
                    denom: txContext.denom,
    ...
    static createSubmitProposal(
        ...
        const txMsg = {
            type: 'kuchain/MsgSubmitProposal',
            value: {
                content: {
                    type: "kuchain/TextProposal",
                    value: {
